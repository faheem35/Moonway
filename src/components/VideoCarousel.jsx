          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="px-8 py-3 bg-yellow-600 text-gray-900 rounded-lg font-semibold hover:bg-yellow-500 transition-colors duration-300 cursor-pointer"
              >
                Get a Quote
              </button>
              ...
              <button
                ...
                className="px-8 py-3 border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-colors duration-300 cursor-pointer"
              >
                View Projects
              </button>
            </div>
